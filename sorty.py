...
column1 = [
    [sg.ReadButton("Original list", size=(13, 1))],
...
layout = [
    ...
    [
        sg.InputText(size=(13, 1), key="_linear_"),
        sg.Text("  "),
        sg.InputText(size=(13, 1), key="_binary_"),
    ],
    [
        sg.ReadButton("Linear Search", size=(13, 1)),
        sg.Text(" "),
        sg.ReadButton("Binary Search", size=(13, 1)),
    ],
]
